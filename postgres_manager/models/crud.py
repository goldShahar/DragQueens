...
def read_type(values: dict[str, str | list[bool]]):
    return read_type_from_pg({"type_name": values.get("type_name"), "Importance": values.get("Importance"), "Min_time": values.get("Min_time"),
                               "Min_area": values.get("Min_area")}, values.get("selected_columns"))